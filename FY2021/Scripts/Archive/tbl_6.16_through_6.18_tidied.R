...
# Info --------------------------------------------------------------------
#' Table 6.16-6.18 DOD TOA
#' 
#' Different from Outlays: does not have trust, receipts** account
...
#'   4) Update Name of specific files
          tbl.6.16.Army <- "FY21 PB Green Book Table 6-16.xlsx"
          tbl.6.17.Navy <- "FY21 PB Green Book Table 6-17.xlsx"
          tbl.6.18.USAF <- "FY21 PB Green Book Table 6-18.xlsx"

#'   5) Set current year
          current.FY <- 2021
          
#'   6) Identify rows for constant and current
        valid.rows <- c( 7:13,  #<-- Current dataset
