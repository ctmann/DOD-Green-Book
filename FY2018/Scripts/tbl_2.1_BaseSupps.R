...
#' 
#' To download as zip
#' http://comptroller.defense.gov/Portals/45/Documents/defbudget/fy2018/FY_2018_Green_Book.zip
#' 
...
t <-  lapply(excel_sheets(my.filename)[1:15], read_excel, path = my.filename, col_names = F, skip = 5 )
...
# Add Spending type column I've devised (base, OCO, emergency relief, other)
  ...
  t$Source_Data <- "FY18 Green Book, tbl 2.1"
